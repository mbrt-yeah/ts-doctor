...
const handleIndexSchema: TFileSchemaHandler = async function(
    ...
    const page: IPage<IApiDoc> = new Page<IApiDoc>({
        content: parameters.apiDoc,
        contentSelector: "apiDoc",
