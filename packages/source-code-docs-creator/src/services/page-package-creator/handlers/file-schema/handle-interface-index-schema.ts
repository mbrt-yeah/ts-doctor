...
const handleInterfaceIndexSchema: TFileSchemaHandler = async function(
    ...
    const page: IPage<IInterfaceDoc[]> = new Page<IInterfaceDoc[]>({
        content: parameters.apiDoc.interfaces,
        contentSelector: "apiDoc.interfaces",
...
export { handleInterfaceIndexSchema };
