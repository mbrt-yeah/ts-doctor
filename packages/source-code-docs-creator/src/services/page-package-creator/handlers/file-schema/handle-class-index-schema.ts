...
const handleClassIndexSchema: TFileSchemaHandler = async function(
    ...
    const page: IPage<IClassDoc[]> = new Page<IClassDoc[]>({
        content: parameters.apiDoc.classes,
        contentSelector: "apiDoc.classes",
